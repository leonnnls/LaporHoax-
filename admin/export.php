            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        ...
                        .css( 'font-size', '10pt' )
                        .prepend(
                            '<img src="https://ypt.or.id/wp-content/uploads/2019/01/Logo-Primer-Utama-ITTelkom-Surabaya-White-300x300.png" style="opacity: 0.5; display:block;margin-left: auto; margin-top: auto; margin-right: auto; width: 100px;" />'
                        );
                    }
                },
                {
...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="index">LaporHoax!</a>
            ...
            <ul class="navbar-nav navbar-sidenav sidebar-menu" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Version">
                    <a class="nav-link" href="">
                        ...
                        <span class="nav-link-text">V-5.0</span>
                    </a>
                </li>
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    <small>Copyright © Telkom University 2024</small>
                </div>
            </div>
        </footer>
