...
<head>
    ...
    <title>Lapor | LaporHoax!</title>
    <link rel="shortcut icon" href="images/kominfo.ico">
    <!-- Bootstrap CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="home">
                        <img alt="Brand" src="images/kominfo.png">
                    </a>
                </div>
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="tujuan">
                                        <option value="1">Hoaks Berita</option>
                                        <option value="2">Hoaks Kesehatan</option>
                                        <option value="3">Hoaks Politik</option>
                                        <option value="4">Hoaks Sejarah</option>
                                    </select>
                                </div>
                            </div>
                        </div>
